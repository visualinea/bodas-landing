      ...
      <div className="max-w-screen-lg mx-auto px-4 sm:px-6">
        <div className="text-center">
          <h2 className="font-serif text-2xl sm:text-3xl font-bold text-gray-900 mb-4">
            {COPY.contactStrip.text}
          </h2>
          
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Respuesta inmediata para confirmar disponibilidad, resolver dudas sobre el servicio o coordinar los detalles de tu boda.
          </p>
